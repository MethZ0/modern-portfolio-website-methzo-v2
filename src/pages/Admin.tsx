...
import { Loader2, Plus, Pencil, Trash2, LogOut, ImagePlus } from 'lucide-react';
...
export default function Admin() {
  ...
  function resetForm() {
    setForm({
      title: '', slug: '', category: 'web-app', description: '', cover_image: '',
      tech_stack: '', year: new Date().getFullYear().toString(), client: '', location: '',
      github_url: '', live_url: '', is_featured: false, sort_order: 0, images: '[]',
    });
    setEditingId(null);
    setShowForm(false);
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-sm font-body text-muted-foreground mt-1">Manage your portfolio projects</p>
          </div>
        ...
        {showForm && (
          <Card className="mb-8">
            <CardHeader>
              <CardTitle className="font-display text-xl italic">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    className="font-body min-h-24 resize-none"
                    required
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  {form.cover_image && (
                    <img src={form.cover_image} alt="Preview" className="mt-2 rounded-lg h-32 object-cover" />
                  )}
                </div>
                        ...
                        return Array.isArray(imgs) ? imgs.map((img: any) => (
                          <div key={img.id} className="relative group">
                            ...
                            <button
                              ...
                              className="absolute -top-2 -right-2 size-5 rounded-full bg-destructive text-destructive-foreground text-xs flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                            >
                              ×
                            </button>
                          </div>
                ...
                <div className="flex gap-2">
                  ...
                  <Button type="button" variant="ghost" onClick={resetForm} className="font-body">
                    Cancel
                  </Button>
                </div>
              </form>
        ...
        <div className="space-y-3">
          {projects.map((project) => (
            ...
            >
              {project.cover_image && (
                <img src={project.cover_image} alt="" className="size-14 rounded-lg object-cover shrink-0" />
              )}
